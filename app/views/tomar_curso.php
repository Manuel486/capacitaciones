        ...
        <div class="mx-auto px-4 sm:px-6 lg:px-30 2xl:px-50 py-6">
            <div class="grid grid-cols-1"
                ...
                <section class="order-2 lg:order-2"
                    :class="{'lg:col-span-8': !modo_evaluacion, 'lg:col-span-1': modo_evaluacion}">
                    ...
                    <template x-if="!cargando">
                        <div class="bg-white rounded-2xl overflow-hidden">
                            ...
                            <template x-if="item_actual.tipo === 'anuncio'">
                                <div
                                    class="bg-gradient-to-br from-blue-50 to-indigo-50 min-h-[400px] flex items-center justify-center p-8">
                                    <div
                                                ...
                                                <div class="lg:col-span-1">
                                                    <div class="bg-white rounded-xl shadow-lg p-6 sticky top-4">
                                                        ...
                                                        <div class="mb-6">
                                                            <div class="flex items-center justify-between mb-2">
                                                                <span
                                                                    class="text-sm font-medium text-gray-600">Progreso</span>
                                                            ...
                                                            <div class="w-full bg-gray-200 rounded-full h-2">
                                                                <div class="bg-gradient-to-r from-blue-500 to-indigo-600 h-2 rounded-full transition-all duration-300"
                                                                    :style="'width: ' + ((Object.keys(respuestas_evaluacion).length / item_actual.detalle.preguntas.length) * 100) + '%'">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="space-y-2 max-h-96 overflow-y-auto">
                                                                <template
                                                                    x-for="(pregunta, index) in item_actual.detalle.preguntas"
                                                                    :key="pregunta.id_pregunta">
                                                                    <button type="button" @click="irAPregunta(index)"
                                                                        :class="[
                                                                        ...
                                                                        pregunta_actual === index 
                                                                            ...
                                                                            <template
                                                                                x-if="obtenerRespuesta(pregunta.id_pregunta) && pregunta_actual !== index">
                                                            ...
                                                            <div x-show="pregunta_actual === index"
                                                                ...
                                                                <div class="mb-6">
                                                                    <div class="flex items-center gap-3 mb-4">
                                                                        <div
                                                                            class="bg-gradient-to-r bg-blue-900 text-white rounded-full w-12 h-12 flex items-center justify-center font-bold text-lg shadow-md">
                                                                            <span x-text="index + 1"></span>
                                                                        </div>
                                                                        <div>
                                                                            <span
                                                                                class="text-sm text-gray-500 font-medium">Pregunta
                                                                                <span x-text="index + 1"></span> de
                                                                                <span
                                                                                    x-text="item_actual.detalle.preguntas.length"></span></span>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="space-y-3">
                                                                    <template
                                                                        x-for="(alternativa, altIndex) in pregunta.alternativas"
                                                                        ...
                                                                        <div @click="guardarRespuesta(pregunta.id_pregunta, alternativa.id_alternativa)"
                                                                            ...
                                                                            <label
                                                                                ...
                                                                                <div
                                                                                    class="flex items-center justify-center w-6 h-6 flex-shrink-0 mt-1">
                                                                                    <input type="radio"
                                                                ...
                                                                <div
                                                                    class="flex items-center flex-wrap justify-between gap-2 mt-8 pt-6 border-t border-gray-200">
                                                                    <button type="button" @click="anteriorPregunta()"
                                                                    ...
                                                                    <button type="button" @click="siguientePregunta()"
                                                ...
                                                <template x-if="!comentarios_cargando">
                                                    <div class="space-y-6">
                                                        <div class="flex justify-between items-center mb-4">
                                                            <h3 class="text-lg font-semibold text-gray-900">Comentarios
                                                            </h3>
                                                        ...
                                                        <template x-if="comentarios.length === 0">
                                                            <div class="flex flex-col items-center py-8">
                                                                <i
                                                                    class="fas fa-comments text-4xl text-gray-300 mb-2"></i>
                        ...
                        <div class="flex-1 overflow-y-auto">
                            <template x-for="(tema, temaIndex) in curso.temas" :key="tema.id_tema">
                                <div class="border-b border-gray-100">
                                    ...
                                    <div
                                        class="p-4 bg-gradient-to-r from-gray-50 to-blue-50 border-l-4 border-blue-500">
