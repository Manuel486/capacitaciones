...
class CursoModel
{
    ...
    public function listarCursos()
    {
        ...
        try {
            $query = "SELECT id_curso, nombre, descripcion FROM curso";
    ...
    public function obtenerCursoPorId($idCurso)
    {
        $pdo = ConexionCapacitaciones::getInstancia()->getConexion();
        try {
            $query = "SELECT c.id_curso, c.nombre, c.descripcion, c.activo, CONCAT(u.apellidos, ' ', u.nombres) AS instructor
                      FROM curso c
                      INNER JOIN usuario u ON c.id_autor = u.id_usuario
